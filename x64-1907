...
CONFIG_DEFAULT_luci-app-control-mia=y
...
CONFIG_DEFAULT_luci-app-pptp-vpnserver-manyusers=y
CONFIG_DEFAULT_luci-app-ramfree=y
CONFIG_DEFAULT_luci-app-trojan-server=y
...
# CONFIG_PACKAGE_kmod-sp5100_tco is not set
...
# CONFIG_PACKAGE_kmod-airo is not set
...
# CONFIG_PACKAGE_php7-mod-hash is not set
...
# CONFIG_PACKAGE_php7-mod-mysqlnd is not set
CONFIG_PACKAGE_php7-mod-opcache=y
# CONFIG_PACKAGE_php7-mod-openssl is not set
# CONFIG_PACKAGE_php7-mod-pcntl is not set
# CONFIG_PACKAGE_php7-mod-pdo is not set
# CONFIG_PACKAGE_php7-mod-pdo-mysql is not set
# CONFIG_PACKAGE_php7-mod-pdo-pgsql is not set
# CONFIG_PACKAGE_php7-mod-pdo-sqlite is not set
...
# CONFIG_PACKAGE_php7-mod-sqlite3 is not set
